...
args
  ...
  .option(['X', 'customLevels'], 'Override default levels (`-cl err:99,info:1`)')
  .option(['Y', 'customColors'], 'Override default colors using names from https://www.npmjs.com/package/colorette (`-cc err:red,info:blue`)')
