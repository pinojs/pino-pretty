 ...
 *
 * @param {object} log The log object to be modified.
 * @param {Set<string> | Array<string> | undefined} ignoreKeys An array of strings identifying the properties to be removed.
 * @param {Set<string> | Array<string> | undefined} includeKeys An array of strings identifying the properties to be included.
 *
